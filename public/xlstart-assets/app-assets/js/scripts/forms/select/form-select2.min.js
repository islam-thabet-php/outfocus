!function (t) {
    ...
    t(".select2").select2({dropdownAutoWidth: !0, width: "100%"}), t(".select2-icons").select2({
        dropdownAutoWidth: !0,
        width: "100%",
    ...
    t(".select2-data-array").select2({
        ...
        t(".select2-customize-result").select2({
            dropdownAutoWidth: !0,
            width: "100%",
