...
class ClientController extends BaseController
{
    ...
    protected function setUp(){
        $data['entityName'] = 'client';
        $data['page'] = ['name'=>'simple-crud','title' => __('Clients Management')];
        $data['columns'] = [
...
//
        ...
        $data['actions'] = true;
        $data['form']['route'] = 'clients';
        $data['form']['title'] = __('Add New Client');
        $data['editForm']['title'] = __('Edit Client');
        $data['form']['fields'] = [
            [
                'type' => 'text',
                'name' => 'name',
            ...
            [
                ...
                'update_rules' =>'',
                'class' => 'extra-class-names',
                'placeholder' =>  __('Enter Client Notes'),
            ],
            [
                'type' => 'text',
                'name' => 'balance',
                ...
                'update_rules' =>'required',
                'class' => 'extra-class-names',
                'placeholder' =>  __('Enter Client Balance'),
            ],
        ];
