...
class WithdrawalController extends BaseController
{
    ...
    protected function setUp(){
        $data['entityName'] = 'withdrawal';
        $data['page'] = ['name'=>'simple-crud','title' => __('Withdrawals Management')];
        $data['columns'] = [
...
//
            ...
            ['label'=>__('Withdraw From'),'field'=>'withdrawal.name','type'=>'model_relation'],
            ['label'=>__('Amount'),'field'=>'amount','type'=>'text'],
            ['label'=>__('Date'),'field'=>'created_at','type'=>'text'],
        ];
        $data['actions'] = true;
        $data['form']['route'] = 'withdrawals';
        $data['form']['title'] = __('Add New Withdrawals');
        $data['editForm']['title'] = __('Edit Withdrawal');
        $data['form']['fields'] = [
            [
                'type' => 'text',
                'name' => 'name',
                ...
                'placeholder' =>  __('Enter Withdrawal Name'),
            ],
            [
                'notCrud' => false,
                'type' => 'select',
    ...
    public function afterStore($entity, $request){
        $entity->withdrawal_id = auth()->user()->id;
        $entity->save();
        return $entity;
    }
