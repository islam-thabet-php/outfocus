            ...
            <section id="basic-horizontal-layouts">
                <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('New Payment') }}</h4>
                                </div>
                                <div class="card-body">
                                    <form id="crud-form" method="post" action="{{ route('project.payments.save',['id'=>$project->id]) }}" class="form form-horizontal">
                                        @csrf
                                        <div class="form-body">
                    ...
                    <div class="col-md-8 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Project Payments') }}</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" style="">
                                                            <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('del_{{$payment->id}}').submit();">
                                                                <i class="bx bx-trash mr-1"></i>Delete</a>
                                                            <form id="del_{{$payment->id}}" action="{{ route('project.payment.delete',['id'=>$payment->id]) }}" method="POST" class="d-none">
                                                                @csrf
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ $project_payments->sum('amount') }}</th>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
